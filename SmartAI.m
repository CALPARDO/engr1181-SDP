...
for N = 1:1000
    ...
    elseif rem(N,2) == 0
        ...
        elseif CM ~= 1
            if NewBoard(c) == hit_s
                if PlayersShips(c) == 3         %%if hit on the left side of the ship
                ...
                elseif PlayersShips(c) == 4     %%if hit on a horizontal piece 
                ...
                elseif PlayersShips(c) == 5     %%if hit is on the right side of the ship
                ...
                elseif PlayersShips(c) == 6     %%if hit is on the top
                [c] = board_display(c) - 1;     %computer guesses cell below
                ...
                elseif PlayersShips(c) == 7     %%if hit is on the vertical piece
                ...
                elseif PlayersShips(c) == 8     %%if the hit is on the bottom of the ship
